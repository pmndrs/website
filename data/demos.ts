const BASE = 'https://pmndrs.github.io/examples'
...
export type Demo = {
  ...
  embedUrl: string
  isNew?: boolean
  article?: { title: string; href: string; author: string }
}

function demo(name: string, opts: Omit<Demo, 'name' | 'thumb' | 'embedUrl'> = {}): Demo {
  return {
    name,
    thumb: `${BASE}/${name}/thumbnail.webp`,
    embedUrl: `${BASE}/${name}/`,
    ...opts,
  }
}
...
export const demos: Demo[] = [
  demo('flow-shield', {
    isNew: true,
    article: {
      title: 'Creating an Interactive Sci-Fi Shield',
