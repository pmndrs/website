    ...
    <div className="pointer-events-none fixed bottom-4 left-4 z-40 sm:bottom-8 sm:left-8">
      <div className="relative">
        {collapsed ? (
          ...
          >
            <span className="text-[0.6rem] leading-none tracking-[0.08em] uppercase">New Article</span>
            <svg viewBox="0 0 10 10" aria-hidden className="h-[0.7rem] w-[0.7rem]">
              <path d="M2 5H8M5 2V8" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" />
            </svg>
          </button>
        ) : (
